...
class Dimensions {
  ...
  //this gets the height of the device and divide it by the page view height(220)
  static double pageViewContainer = screenHeight / 3.84;
  //this gets the height of the device and divide it by the text view container height(110)
  static double pageViewTextContainer = screenHeight / 7.03;
  //this gets the height of the device and divide it by the main container height(320)
